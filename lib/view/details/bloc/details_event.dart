...
class SavedUnSavedEvent extends DetailsEvent {}

class AboutTabGetDataEvent extends DetailsEvent {}

class MenuTabGetDataEvent extends DetailsEvent {}

class ReviewTabGetDataEvent extends DetailsEvent {}
